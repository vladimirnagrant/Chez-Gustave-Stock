...
function EmployeeView({ catalogue, onAddRequest, allRequests, history, employees, onToggleReceived, onUpdateComment, onUpdateHistoryComment, currentEmployee, currentUser, pins, onChangePin, myRequests, cashRequests, onAddCashRequest, onToggleCashDelivered, onRemoveCashRequest }) {
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      {tab === "profil" ? (
        ...
        <div className="p-5">
          <PanierCommun allRequests={allRequests} catalogue={catalogue} onUpdateComment={onUpdateComment} />
        </div>
      ) : tab === "historique" ? (
        <div className="p-5">
          {history.length === 0 ? (
...
function PanierCommun({ allRequests, catalogue, onUpdateComment }) {
                ...
                {items.map((r) => (
                  <div key={r.id} className="px-3 py-2 text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-stone-400 text-xs">x{r.quantite} · {r.par}</span>
                    </div>
