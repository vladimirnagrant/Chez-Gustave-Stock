    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-stone-50 px-6">
          ...
          <p className="text-stone-500 text-sm text-center mb-6">Une erreur s'est produite. Clique sur Retour pour recommencer.</p>
        ...
        <div className="p-5">
          ...
          {history.length === 0 ? (
            ...
            <>
              ...
              >
                <Trash2 size={15} /> Effacer tout l'historique
              </button>
            </>
          )}
        </div>
                      ...
                      {items.map((a) => (
                        <div key={a.id} className={`flex items-start gap-2 text-sm py-0.5 rounded-lg px-1 ${a.isReste && mode === "attente" ? "bg-orange-50 border border-orange-200" : ""}`}>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <span className="text-stone-700 flex items-center gap-1 flex-wrap">
