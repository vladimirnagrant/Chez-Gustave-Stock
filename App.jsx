  ...
  return (
    <div className="bg-white border-2 border-dashed border-stone-300 rounded-xl p-4 mb-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <button onClick={onBack} className="text-xs text-stone-400 underline">← Retour</button>
      </div>
      ...
      <button onClick={handleSubmit} className="w-full bg-amber-700 text-amber-50 rounded-xl py-3 font-medium hover:bg-amber-800 transition-colors">Envoyer la demande</button>
    </div>
  );
}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="flex-1 text-stone-700 flex items-center gap-1 flex-wrap">
                        {r.isNouveau ? (
                          ...
                          <>{r.item?.code ? `${r.item.code} · ` : ""}{r.item ? r.item.name : "Article supprimé"}</>
                        )}
                      </span>
                      <div className="flex items-center gap-1">
